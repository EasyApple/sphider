...
if (isset($Submit)) {
	if (!saestor:is_writable("../settings/conf.php")) {
		print "Configuration file is not writable, chmod 666 conf.php under *nix systems";
	} else {
		$fhandle=saestor:fopen("../settings/conf.php","wb");
		saestor:fwrite($fhandle,"<?php \n");
		saestor:fwrite($fhandle,"/***********************\n Sphider configuration file\n***********************/");
		saestor:fwrite($fhandle,"\n\n\n/*********************** \nGeneral settings \n***********************/");
		saestor:fwrite($fhandle, "\n\n// Sphider version \n");
		saestor:fwrite($fhandle,"$"."version_nr			= '".$_version_nr. "';");
		saestor:fwrite($fhandle, "\n\n//Language of the search page \n");
		saestor:fwrite($fhandle,"$"."language			= '".$_language. "';");
		saestor:fwrite($fhandle, "\n\n// Template name/directory in templates dir\n");
		saestor:fwrite($fhandle,"$"."template	= '".$_template. "';");
		saestor:fwrite($fhandle, "\n\n//Administrators email address (logs can be sent there)	\n");
		saestor:fwrite($fhandle,"$"."admin_email		= '".$_admin_email. "';");
		saestor:fwrite($fhandle, "\n\n// Print spidering results to standard out\n");
		saestor:fwrite($fhandle,"$"."print_results		= ".$_print_results. ";");
		saestor:fwrite($fhandle, "\n\n// Temporary directory, this should be readable and writable\n");
		saestor:fwrite($fhandle,"$"."tmp_dir	= '".$_tmp_dir. "';");

		saestor:fwrite($fhandle,"\n\n\n/*********************** \nLogging settings \n***********************/");
		saestor:fwrite($fhandle, "\n\n// Should log files be kept\n");
		saestor:fwrite($fhandle,"$"."keep_log			= ".$_keep_log. ";");
		saestor:fwrite($fhandle, "\n\n//Log directory, this should be readable and writable\n");
		saestor:fwrite($fhandle,"$"."log_dir	= '".$_log_dir. "';");
		saestor:fwrite($fhandle, "\n\n// Log format\n");
		saestor:fwrite($fhandle,"$"."log_format			= '".$_log_format. "';");
		saestor:fwrite($fhandle, "\n\n//  Send log file to email \n");
		saestor:fwrite($fhandle,"$"."email_log			= ".$_email_log. ";");

		saestor:fwrite($fhandle,"\n\n\n/*********************** \nSpider settings \n***********************/");
		saestor:fwrite($fhandle, "\n\n// Min words per page required for indexing \n");
		saestor:fwrite($fhandle,"$"."min_words_per_page = ".$_min_words_per_page. ";");
		saestor:fwrite($fhandle, "\n\n// Words shorter than this will not be indexed\n");
		saestor:fwrite($fhandle,"$"."min_word_length	= ".$_min_word_length. ";");
		saestor:fwrite($fhandle, "\n\n// Keyword weight depending on the number of times it appears in a page is capped at this value\n");
		saestor:fwrite($fhandle,"$"."word_upper_bound	= ".$_word_upper_bound. ";");
		saestor:fwrite($fhandle, "\n\n// Index numbers as well\n");
		saestor:fwrite($fhandle,"$"."index_numbers		= ".$_index_numbers. ";");
		...
		saestor:fwrite($fhandle,"$"."index_host		 = ".$_index_host.";\n");
		saestor:fwrite($fhandle, "\n\n// Wether to index keywords in a meta tag \n");
		saestor:fwrite($fhandle,"$"."index_meta_keywords = ".$_index_meta_keywords. ";");		
		saestor:fwrite($fhandle, "\n\n// Index pdf files\n");
		saestor:fwrite($fhandle,"$"."index_pdf	= ".$_index_pdf. ";");
		saestor:fwrite($fhandle, "\n\n// Index doc files\n");
		saestor:fwrite($fhandle,"$"."index_doc	= ".$_index_doc. ";");
		saestor:fwrite($fhandle, "\n\n// Index xls files\n");
		saestor:fwrite($fhandle,"$"."index_xls	= ".$_index_xls. ";");
		saestor:fwrite($fhandle, "\n\n// Index ppt files\n");
		saestor:fwrite($fhandle,"$"."index_ppt	= ".$_index_ppt. ";");
		saestor:fwrite($fhandle, "\n\n//executable path to pdf converter\n");
		saestor:fwrite($fhandle,"$"."pdftotext_path	= '".$_pdftotext_path	. "';");
		saestor:fwrite($fhandle, "\n\n//executable path to doc converter\n");
		saestor:fwrite($fhandle,"$"."catdoc_path	= '".$_catdoc_path. "';");
		saestor:fwrite($fhandle, "\n\n//executable path to xls converter\n");
		saestor:fwrite($fhandle,"$"."xls2csv_path	= '".$_xls2csv_path	. "';");
		saestor:fwrite($fhandle, "\n\n//executable path to ppt converter\n");
		saestor:fwrite($fhandle,"$"."catppt_path	= '".$_catppt_path. "';");
		saestor:fwrite($fhandle, "\n\n// User agent string \n");
		saestor:fwrite($fhandle,"$"."user_agent			 = '".$_user_agent. "';");
		saestor:fwrite($fhandle, "\n\n// Minimal delay between page downloads \n");
		saestor:fwrite($fhandle,"$"."min_delay			= ".$_min_delay. ";");
		saestor:fwrite($fhandle, "\n\n// Use word stemming (e.g. find sites containing runs and running when searching for run) \n");
		saestor:fwrite($fhandle,"$"."stem_words			= ".$_stem_words. ";");
		saestor:fwrite($fhandle, "\n\n// Strip session ids (PHPSESSID, JSESSIONID, ASPSESSIONID, sid) \n");
		saestor:fwrite($fhandle,"$"."strip_sessids			= ".$_strip_sessids. ";");

		saestor:fwrite($fhandle,"\n\n\n/*********************** \nSearch settings \n***********************/");
		saestor:fwrite($fhandle, "\n\n// default for number of results per page\n");
		saestor:fwrite($fhandle,"$"."results_per_page	= ".$_results_per_page. ";");
		...
		saestor:fwrite($fhandle,"$"."cat_columns		= ".$_cat_columns. ";");
		saestor:fwrite($fhandle, "\n\n// Can speed up searches on large database (should be 0)\n");
		saestor:fwrite($fhandle,"$"."bound_search_result = ".$_bound_search_result. ";");
		saestor:fwrite($fhandle, "\n\n");
		saestor:fwrite($fhandle,"// The length of the description string queried when displaying search results. // If set to 0 (default), makes a query for the whole page text, // otherwise queries this many bytes. Can significantly speed up searching on very slow machines \n");
		saestor:fwrite($fhandle,"$"."length_of_link_desc	= ".$_length_of_link_desc. ";");
		saestor:fwrite($fhandle, "\n\n// Number of links shown to next pages\n");
		saestor:fwrite($fhandle,"$"."links_to_next		 = ".$_links_to_next. ";");
		saestor:fwrite($fhandle, "\n\n// Show meta description in results page if it exists, otherwise show an extract from the page text.\n");
		saestor:fwrite($fhandle,"$"."show_meta_description = ".$_show_meta_description. ";");
		saestor:fwrite($fhandle, "\n\n// Advanced query form, shows and/or buttons\n");
		saestor:fwrite($fhandle,"$"."advanced_search	= ".$_advanced_search. ";");
		saestor:fwrite($fhandle, "\n\n// Query scores are not shown if set to 0\n");
		saestor:fwrite($fhandle,"$"."show_query_scores	 = ".$_show_query_scores. ";	");
		saestor:fwrite($fhandle, "\n\n");
		saestor:fwrite($fhandle, "\n\n // Display category list\n");
		saestor:fwrite($fhandle,"$"."show_categories	 = ".$_show_categories. ";");
		saestor:fwrite($fhandle, "\n\n// Length of page description given in results page\n");
		saestor:fwrite($fhandle,"$"."desc_length		= ".$_desc_length. ";");
		saestor:fwrite($fhandle, "\n\n// Show only the 2 most relevant links from each site (a la google)\n");
		saestor:fwrite($fhandle,"$"."merge_site_results		= ".$_merge_site_results. ";");
		saestor:fwrite($fhandle, "\n\n// Enable spelling suggestions (Did you mean...)\n");
		saestor:fwrite($fhandle,"$"."did_you_mean_enabled	= ".$_did_you_mean_enabled. ";");
		saestor:fwrite($fhandle, "\n\n// Enable Sphider Suggest \n");
		saestor:fwrite($fhandle,"$"."suggest_enabled		= ".$_suggest_enabled. ";");		
		saestor:fwrite($fhandle, "\n\n// Search for suggestions in query log \n");
		saestor:fwrite($fhandle,"$"."suggest_history		= ".$_suggest_history. ";");		
		saestor:fwrite($fhandle, "\n\n// Search for suggestions in keywords \n");
		saestor:fwrite($fhandle,"$"."suggest_keywords		= ".$_suggest_keywords. ";");		
		saestor:fwrite($fhandle, "\n\n// Search for suggestions in phrases \n");
		saestor:fwrite($fhandle,"$"."suggest_phrases		= ".$_suggest_phrases. ";");		
		saestor:fwrite($fhandle, "\n\n// Limit number of suggestions \n");
		saestor:fwrite($fhandle,"$"."suggest_rows		= ".$_suggest_rows. ";");


		saestor:fwrite($fhandle,"\n\n\n/*********************** \nWeights\n***********************/");
		saestor:fwrite($fhandle, "\n\n// Relative weight of a word in the title of a webpage\n");
		saestor:fwrite($fhandle,"$"."title_weight  = ".$_title_weight. ";");
		saestor:fwrite($fhandle, "\n\n// Relative weight of a word in the domain name\n");
		saestor:fwrite($fhandle,"$"."domain_weight = ".$_domain_weight. ";");
		saestor:fwrite($fhandle, "\n\n// Relative weight of a word in the path name\n");
		saestor:fwrite($fhandle,"$"."path_weight	= ".$_path_weight. ";");
		saestor:fwrite($fhandle, "\n\n// Relative weight of a word in meta_keywords\n");
		saestor:fwrite($fhandle,"$"."meta_weight	= ".$_meta_weight. ";");
